...
def contact():
    mess._show(title='Contact us', message="Please contact us on : 'rajuguttula1798@gmail.com' ")
...
def TrackImages():
    ...
    # saving xlsx file
    xls = pd.ExcelWriter('Attendance/Attendance_' + date + '.xlsx')
...
clearButton = tk.Button(frame2, text="Clear", command=clear, fg="#DDDDDD", bg="#00CC00", width=7,height=1,
                        activebackground="#25274D", font=('Neuropolitical', 10))
clearButton.place(relx=0.82, y=91)
clearButton2 = tk.Button(frame2, text="Clear", command=clear2, fg="#DDDDDD", bg="#ea2a2a", width=7,height=1,
                         activebackground="white", font=('Neuropolitical', 10))
clearButton2.place(relx=0.82, y=176)
takeImg = tk.Button(frame2, text="Take Images", command=TakeImages, fg="#DDDDDD", bg="#00CC00", width=25, height=1,
                    activebackground="#00CC00", font=('Neuropolitical', 14))
takeImg.place(x=85, y=300)
trainImg = tk.Button(frame2, text="Save Profile", command=psw, fg="#DDDDDD", bg="#00CC00", width=25, height=1,
                     activebackground="white", font=('Neuropolitical', 14))
trainImg.place(x=85, y=380)
trackImg = tk.Button(frame1, text="Take Attendance", command=TrackImages, fg="#DDDDDD", bg="#00CC00", width=25, height=1,
                     activebackground="#00CC00", font=('Neuropolitical', 14))
